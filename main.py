...
def swap_letters(word):
    ...
    tail = len(newList)
    onetwo = newList[0:2]
    lasttwo = newList[tail - 2:tail]
    middle = newList[2:tail - 2]
    currPass = lasttwo + middle + onetwo
    return "".join(currPass)


temp_number = int(input("Please enter a number between 3 and 7:"))

if temp_number < 3 or temp_number > 7:
    print("You have entered invalid value.")

else:
    tempPass = passGen(temp_number)
    print(rep_with_upper(tempPass))
    print(swap_letters(tempPass))
